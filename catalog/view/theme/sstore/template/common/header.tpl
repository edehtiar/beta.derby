...
<?php } ?>
                ...
                <div class="sidebar-a">
                    ...
                    <ul>
                        ...
                        <?php if($storeset_cont_phone1 != '') { ?>
                            <li><a href="tel:<?php echo str_replace(" ", "", str_replace("+", "", str_replace("(", "", str_replace(")", "", str_replace("-", "", $storeset_cont_phone1))))); ?>"><?php echo $storeset_cont_phone1; ?></a></li>
                        <?php } ?>
                        <?php if($storeset_cont_phone2 != '') { ?>
                            <li><a href="tel:<?php echo str_replace(" ", "", str_replace("+", "", str_replace("(", "", str_replace(")", "", str_replace("-", "", $storeset_cont_phone2))))); ?>"><?php echo $storeset_cont_phone2; ?></a></li>
                        <?php } ?>
    ...
    <div class="container">
       <!-- ============ header =================== -->
            <header class="row">                
                <?php if($storeset_status == "on") { ?> 
                    ...
                    <i class="fa fa-<?php echo $storeset_custom_icon1; ?> contacts-fa"></i>
                        <div id="phone">
                            <div><?php if($storeset_cont_phone1 != '') { ?>
                                <a href="tel:<?php echo str_replace(" ", "", str_replace("+", "", str_replace("(", "", str_replace(")", "", str_replace("-", "", $storeset_cont_phone1))))); ?>"><?php echo $storeset_cont_phone1; ?></a>
                                
                            <?php } ?></div>
                            <div><?php if($storeset_cont_phone2 != '') { ?>
                                <a href="tel:<?php echo str_replace(" ", "", str_replace("+", "", str_replace("(", "", str_replace(")", "", str_replace("-", "", $storeset_cont_phone2)))));?>"><?php echo $storeset_cont_phone2; ?></a>
                            <?php } ?></div>
                        </div>
                    ...
                    <i class="fa fa-<?php echo $storeset_custom_icon2; ?>"></i>
                        <div><?php if($storeset_cont_clock != '') { ?>
		...
		<img class="megamenu-thumb" src="<?=$item['thumb']?>" alt="<?php echo $item['name']; ?>" title="<?php echo $item['name']; ?>"/>
        ...
        <?php } else { ?>
         <li><a href="<?php echo $item['href']; ?>"><?if($item['thumb']){?>
		<img class="megamenu-thumb" src="<?=$item['thumb']?>" alt="<?php echo $item['name']; ?>" title="<?php echo $item['name']; ?>"/>
